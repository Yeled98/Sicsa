<!DOCTYPE html>
  <html>
    <head lang="la">
      ...
      <meta charset="utf-8">
      <title>Cucaracha Americana ¿Sabías esto sobre ellas?</title>
        ...
        <div class="row">
          <div class="col l8 offset-l2 s10 offset-s1 card blue accent-1 hoverable">
            <div class="card-image">
              <img src="img/cucaracha-americana.jpg" alt="Cucaracha Alemana" class="responsive-img">
            </div>
            <h3>Cucaracha Americana</h3>
            <p>La  cucaracha americana es conocida con varios sobrenombres como cucaracha voladora o cucaracha de tierra caliente, entre otros. Es la especie más grande llegando a medir hasta 1,5 pulgadas de longitud, su color es café rojizo, machos y hembras son alados, sobresaliendo del abdomen las alas en los machos, mientras que en las hembras las alas son de la misma longitud que el abdomen.</p>
            <h5>Identificación</h5>
            <p>La  cucaracha americana es conocida con varios sobrenombres como cucaracha voladora o cucaracha de tierra caliente, entre otros. Es la especie más grande llegando a medir hasta 1,5 pulgadas de longitud, su color es café rojizo, machos y hembras son alados, sobresaliendo del abdomen las alas en los machos, mientras que en las hembras las alas son de la misma longitud que el abdomen.</p>
            <h5>Habitat</h5>
            <p>Drenajes, Cisternas, techos, lugares húmedos, calurosos, grietas o ranuras, motores de aparatos electrónicos, sistemas eléctricos.</p>
            <h5>Dato Curioso</h5>
            <p>Tienen alas perfectamente bien desarrolladas pero raramente vuelan. Son capaces de planear grandes distancias principalmente distancias cortas como desde un árbol hasta un techo.</p>
