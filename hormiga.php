<!DOCTYPE html>
  <html>
    <head lang="la">
      ...
      <meta charset="utf-8">
      <title>Hormigas Aprende todo sobre este increíble Insecto</title>
        ...
        <div class="row">
          <div class="col l8 offset-l2 s10 offset-s1 card hoverable">
            <div class="card-image">
              <img src="img/hormiga.jpg" alt="Hormiga" class="responsive-img">
            </div>
            <h3>Hormiga Casera</h3>
            <h5>Identificación</h5>
            <p>La hormiga Casera por lo general es de color café oscuro y puede llegar a medir de 1/8 a 1/6 de pulgada.</p>
            <h5>Habitat</h5>
            <p>A las hormigas caseras se les puede encontrar generalmente en el exterior, por ejemplo, bajo piedras, junto a edificios y grietas.</p>
            <h5>Dato Curioso</h5>
            <p>A ellas al igual que a muchos de nosotros les encantan los alimentos dulces o muy grasosos.</p>
