<!DOCTYPE html>
  <html>
    <head lang="la">
      ...
      <meta charset="utf-8">
      <title>Mosquitos: ¿Cómo evitarlos? | TODO lo que debes saber sobre ellos</title>
        ...
        <div class="row">
          <div class="col l8 offset-l2 s10 offset-s1 card hoverable">
            <div class="card-image">
              <img src="img/mosquito.jpg" alt="Mosquito" class="responsive-img">
            </div>
            <h3>Zancudo</h3>
            <h5>Identificación</h5>
            <p>El Zancudo, por lo general llamado mosquito mide aproximadamente 15 mm y su color es gris.</p>
            <h5>Habitat</h5>
            <p>Los mosquitos acostumbran vivir cerca de estanques o recipientes con agua a la intemperie.</p>
            <h5>Dato Curioso</h5>
            <p>Solo las hembras son las que se alimentan de sangre.</p>
