<!DOCTYPE html>
  <html>
    <head lang="la">
      ...
      <meta charset="utf-8">
      <title>Los Ratones: Roedores MUY Interesantes | ¿Es lo mismo una Rata que un Ratón?</title>
      ...
      <main>
        <div class="row">
          <div class="col l8 offset-l2 s10 offset-s1 card blue accent-1 hoverable">
            ...
            <h3>Ratón Doméstico</h3>
            <h5>Identificación</h5>
            <p>Se identifica por un cuerpo delgado y pequeño, pesando de 150 a 250 g como adulto. Sus orejas son largas, la cola está semidesnuda y es tan larga como la cabeza y el cuerpo juntos.</p>
            <p>El pelo es gris obscuro en el lomo y gris claro en el vientre, pero son posibles muchas variaciones.</p>
            <h5>Habitat</h5>
            <p>Areas suburbanas, y rurales,  edificioa, casa, entre la maleza, y las hierbas, cerca de los cimientos de edificios, dentro de cobertizos de almacenaje, en confinamientos y espacios en donde se puedan deslizar por debajo de las estructuras.</p>
            <p>Nocturnos teniendo sus periodos pico de actividad al anochecer y antes del amanecer.</p>
            <h5>Dato Curioso</h5>
            <p>Omnivoros en especial granos de cereal. Requieren de 5 a 15 ml de agua diariamente.</p>
