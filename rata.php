<!DOCTYPE html>
  <html>
    <head lang="la">
      ...
      <meta charset="utf-8">
      <title>Ratas: TODO lo que debes saber sobre ellas | Evita una de las Plagas más comunes</title>
        ...
        <div class="row">
          <div class="col l8 offset-l2 s10 offset-s1 card blue accent-1 hoverable">
            <div class="card-image">
              <img src="img/rata.jpg" alt="Rata" class="responsive-img">
            </div>
            <h3>Rata Noruega</h3>
            <h5>Identificación</h5>
            <p>También conocida como rata doméstica. Tiene el cuerpo robusto, pesa entre 12 y 16 onzas ( 200 a 500 gramos como adulto. Son más pesadas de lo que parecen. La piel de su cuerpo es gruesa y varía de rojiza a café grisacea pero tiene partes por debajo de su abdomen color blanquizco. La nariz es chata, las orejas pequeñas, su cola es escamosa, semidesnuda y mas corta que la cabeza y el cuerpo combinados.</p>
            <h5>Habitat</h5>
            <p>Generalmente vive a nivel del piso, como tal , frecuentemente anida en exteriores, en lugares donde se resguarda subterráneamente. Habitan en residencias, edificios, todo tipo de instalaciones alimenticias, almacenes, tiendas, moteles, zoologicos, alcantarillas y basureros, es común encontrarlas en lagos y parques. </p>
            <h5>Dato Curioso</h5>
            <p>Requieren de 25 a 30 gramos de alimento diariamente. Prefieren el alimento con contenido proteínico y de carbohidratos elevados aunque ingerirá casi todo tipo de alimento.</p>
