<!DOCTYPE html>
  <html>
    <head lang="la">
      ...
      <meta charset="utf-8">
      <title>TODO lo que necesitas saber de las Cucarachas Alemanas</title>
        ...
        <div class="row">
          <div class="col l8 offset-l2 s10 offset-s1 card blue accent-1 hoverable">
            <div class="card-image">
              <img src="img/cucaracha.jpg" alt="Cucaracha Alemana" class="responsive-img">
            </div>
            <h3>Cucaracha Alemana</h3>
            <p>Sin duda la plaga de mayor repercusión económica siendo una de las más comunes de encontrar en casas, restaurantes  y edificios.</p>
            <h5>Identificación</h5>
            <p>Son de color café claro miden de ½ a 5/8 de pulgadas de longitud.</p>
            <h5>Habitat</h5>
            <p>Lugares húmedos, calurosos, grietas o ranuras, motores de aparatos electrónicos, sistemas eléctricos.</p>
            <h5>Alimentación</h5>
            <p>La cucaracha alemana es en general omnivora ( puede digerirlo todo omnis” todo”, vorus “ que come)  siendo particularmente atraida por alimento fermentado o residuos de bebida. Si se encuentra presente una fuente de agua, los adultos podrán sobrevivir por más de un mes aunque no exista comida.</p>
